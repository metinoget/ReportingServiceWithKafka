...
public static class ReportMicroserviceEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ReportMicroserviceModuleExtensionConfigurator CLASS (in the Domain.Shared project)
